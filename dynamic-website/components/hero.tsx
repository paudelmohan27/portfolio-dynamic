      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="grid gap-12 md:grid-cols-2 items-center">
          <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6">
            ...
            <motion.p variants={itemVariants} className="text-xl md:text-2xl text-muted-foreground mb-6">
              A beginner web developer passionate about creating interactive and user-friendly web experiences.
            </motion.p>
          ...
          <motion.div variants={imageVariants} initial="hidden" animate="visible" className="flex justify-center">
            <div className="relative">
              <div className="absolute -inset-4 rounded-full bg-gradient-to-br from-primary/20 via-primary/10 to-transparent blur-xl animate-pulse"></div>
              <div className="relative w-64 h-64 md:w-80 md:h-80 bg-gradient-to-br from-primary/30 to-primary/10 rounded-full flex items-center justify-center">
                <div className="absolute inset-2 overflow-hidden rounded-full border-4 border-primary/20">
                  <img src="/mohan.png" alt="Mohan Paudel" className="w-full h-full object-cover" />
                </div>
              </div>
